	...
	<div class="wrapper style2">
		<article id="work">
			...
			<div class="container">
				...
				<b>Login to view Personal Information</b>
				<br>
				<br>
	...
	<div class="wrapper style4">
		<article id="contact" class="container small">
			...
			<div>
				...
				<br>Login credentials for user1 : username - 'user1', password - '145_Bluxome'
				<br> There is another user with username 'user2'. You have to steal his personal information by exploiting the vulnerability
				on this page.
				<br>
				<br>
							...
							<li>
								...
								<DIV id="solution" style="display:none">
									<P>
										...
										<br>i.e. sessionID=a1881c06eec96db9901c7bbfe41c42a3f08e9cb4
									</P>
