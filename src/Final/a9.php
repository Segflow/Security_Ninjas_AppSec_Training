				...
				<div class="row">
					<div class="12u">
						<ul>
							...
							<li>
								<H5 style="cursor: pointer" onclick="toggleBlock(this, 'hint2');"> Hint 2 </H5>
								<DIV id="hint2" style="display:none">
									<P>
										This page uses jquery-1.6.1
										<br>
										<a href="http://www.cvedetails.com/cve/CVE-2011-4969/" target="_blank">CVE details</a>
										<br>
										<a href="http://blog.mindedsecurity.com/2011/07/jquery-is-sink.html" target="_blank">Exploit details</a>
									</P>
							...
							<li>
								...
								<DIV id="solution" style="display:none">
									<P>
										Append "#&lt;img src=x onerror=alert(1)&gt;" at the end of the URL. Note that this proof of concept attack might not pop
										up an alert if your browser has anti-XSS protections. You might need to refresh the page or wait for a few moments
										for the pop up to actually show.
									</P>
