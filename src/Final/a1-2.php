...
<head>
    ...
    <script>
        ...
        function validateForm() {
            var domain = document.getElementById("site_input").value;
    ...
    <div class="wrapper style2">
        <article id="work">
            ...
            <div class="container">
                ...
                <form method="POST" action="a1_lookup.php" onsubmit="return validateForm()">
                    Domain Name
                    <input id="site_input" type="text" name="site">
                    <br>
    ...
    <div class="wrapper style4">
        <article id="contact" class="container small">
            <header>
                ...
                <p>There can be many types of Injection.</p>
            </header>
            <div>
                <div class="row">
                    <div class="12u">
