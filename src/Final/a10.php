	...
	<div class="wrapper style2">
		<article id="work">
			...
			<div class="container">
				...
				<center>
					<img src="images/a.jpeg" alt="image" align="center">
				</center>
						...
						<ul>
							...
							<li>
								...
								<DIV id="hint2" style="display:none">
									<P>
										Edit the parameter 'redirect_to' to include a malicious URL. Note that there is validation done on the redirect location
										on the back end but that is imperfect.
									</P>
							...
							<li>
								...
								<DIV id="solution" style="display:none">
									<P>
										...
										<br> e.g. opendns.com.internetbadguys.com
									</P>
